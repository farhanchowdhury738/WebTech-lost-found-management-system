...
$item = $database->getItemById($connection, $_GET["id"] ?? ($_SESSION["claim_item_id"] ?? 0));
...
<?php foreach (["claimNameError", "claimEmailError", "claimPhoneError", "claimDescriptionError", "claimProofError"] as $k)
    unset($_SESSION[$k]);
include "footer.php"; ?>