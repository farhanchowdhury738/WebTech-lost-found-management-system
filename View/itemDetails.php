...
<div class="card">
    ...
    <p><span class="badge"><?php echo htmlspecialchars($item["type"]); ?></span> <span class="badge"><?php echo htmlspecialchars($item["status"]); ?></span></p>
    <div class="grid">
        <div><?php if ($item["image_path"]): ?><img class="item-img" src="<?php echo htmlspecialchars($item["image_path"]); ?>"><?php endif; ?></div>
        <div>
            <h3>Item Details</h3>
            <p class="meta">
